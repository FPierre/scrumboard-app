    ...
    <div class='container'>
      <div class='tabs-content'>
        <template v-if='isSprint'>
          ...
          <template v-if='inProgressIsCurrentSprint'>
...
export default {
  ...
  computed: {
    ...mapGetters({
      sprint: 'scrum/currentSprint',
      inProgressSprint: 'scrum/inProgressSprint',
      inProgressIsCurrentSprint: 'scrum/inProgressIsCurrentSprint'
    }),
    isSprint () {
    ...
    actuallyDone () {
      let toto = this.sprint.points.done
  ...
  created () {
    ...
    this.showLine = true
    this.setCurrentSprintId = this.$route.params.id
  },
  methods: {
    ...mapActions({
